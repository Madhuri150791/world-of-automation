...
{/* <img src="images/Network-Automation.png" alt="Network Automation" title="Network Automation" /> */}

import React from "react"
import myImage from "./images/Network-Automation.png"

export const MyComponent = () => {
  return (
    <div>
      <img src={myImage} alt="Alt text" height={200} style={{border: "1px solid black"}} />
    </div>
  )
}
